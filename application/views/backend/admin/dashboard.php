                    ...
                    <div class="col-md-3 col-sm-6">
                      <div class="white-box bg-purple">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4>
									<strong style="color:white"><?php echo $this->db->count_all_results('accountant');?>
									 </strong>
									 </h4>
                                    <span class="text-muted"><a href="#" style="color:white"><?php echo get_phrase('Accontants');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="r-icon-stats">
                                ...
                                ?>
								   ...
								   <?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?> <?php echo $expense_amount;?>
                                    ...
                                    <span class="text-muted"><a href="#" style="color:white"><?php echo get_phrase('Expense');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="r-icon-stats">
                                ...
                                $income_amount = $query->row()->amount; ?>
                                   <h4><strong style="color:white">
                                    ...
                                    <span class="text-muted"><a href="#" style="color:white"><?php echo get_phrase('Income');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
								   ...
								   <?php echo $this->db->count_all_results('admin');?>
                                    ...
                                    <span class="text-muted"><a href="#" style="color:white"><?php echo get_phrase('Admin');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                   <h4><strong style="color:white">
                                    ...
                                    <span class="text-muted"><a href="#" style="color:white"><?php echo get_phrase('Attendance');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
